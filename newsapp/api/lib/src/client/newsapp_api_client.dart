...
/// {@template newsapp_api_malformed_response}
...
class NewsappApiMalformedResponse implements Exception {
  /// {@macro newsapp_api_malformed_response}
...
/// {@template newsapp_api_client}
/// A Dart API client for the newsapp API.
/// {@endtemplate}
class NewsappApiClient {
  /// Create an instance of [NewsappApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro newsapp_api_client}
  NewsappApiClient({
